        ...
        <div className="space-y-4 sm:space-y-6">
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              <div className="bg-roof-100 p-1.5 sm:p-2 rounded-full">
                <Calendar className="h-5 w-5 text-roof-600" />
              </div>
              <h1 className="text-lg sm:text-2xl font-bold text-roof-800">Mijn planning</h1>
            </div>
            
            <div className="bg-white rounded-lg p-3 sm:p-4 shadow-sm border flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              <div className="flex items-center gap-2">
                <Users className="h-4 w-4 sm:h-5 sm:w-5 text-roof-500" /> 
                <span className="text-sm font-medium">Actief team:</span>
                <span className="text-roof-600 font-semibold text-sm sm:text-base">{selectedTeam?.name}</span>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  className="border rounded-md px-2 py-1 text-sm focus:outline-none focus:ring-2 focus:ring-roof-400 min-w-[140px]"
                >
                  {teams.map(team => (
