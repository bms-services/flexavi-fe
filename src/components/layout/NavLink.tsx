      ...
      <div className="w-full">
        <button
          ...
          className={cn(
            ...
            hasActiveChild && "bg-sidebar-accent/30 text-sidebar-foreground"
          )}
        >
        ...
        {isOpen && (
          <div className="mt-0.5 space-y-0.5">
            {children.map((child) => (
              ...
              >
                {child.icon ? <child.icon className="mr-2 h-4 w-4 opacity-75" /> : <FileText className="mr-2 h-4 w-4 opacity-75" />}
