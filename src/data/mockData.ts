...
// Create mock appointments with more dummy data for all workdays
export const mockAppointments: Appointment[] = [
  ...
  },
  {
    ...
    leadId: "lead-003",
    title: "Dakrenovatie",
    description: "Uitvoering renovatieproject",
  ...
  },
  {
    ...
    leadId: "lead-005",
    title: "Dakonderhoud",
    description: "Complete dakrenovatie",
    date: formatDate(today),
    startTime: "13:00",
    endTime: "17:00",
    status: "scheduled",
  ...
  },
  {
    id: "app-006",
    leadId: "lead-001",
    title: "Daklekkage inspectie",
    description: "Spoedinspectie van daklekkage in woonkamer",
    date: formatDate(today),
    startTime: "11:00",
    endTime: "12:30",
  ...
  },
  {
    id: "app-007",
    leadId: "lead-003",
    title: "Zonnepanelen offerte",
    description: "Klant wil offerte voor installatie zonnepanelen",
    date: formatDate(today),
    startTime: "14:00",
    endTime: "15:30",
    status: "quote_request",
  ...
  },
  {
    id: "app-008",
    leadId: "lead-004",
    title: "Dakkapel meting",
    description: "Exacte meting voor plaatsing nieuwe dakkapel",
    date: formatDate(addDays(today, 1)),
    startTime: "09:30",
    endTime: "11:00",
    status: "scheduled",
  ...
  },
  {
    ...
    description: "Nacontrole vorige reparatie onder garantie",
    date: formatDate(addDays(today, 1)),
    startTime: "10:00",
    endTime: "11:30",
    status: "warranty",
    ...
    updatedAt: formatDateTime(subDays(today, 6)),
  },
  {
    id: "app-010",
    leadId: "lead-001",
    title: "Isolatie inspecteren",
    description: "Controleren van dakisolatie en advies",
    date: formatDate(addDays(today, 2)),
    startTime: "13:30",
    endTime: "15:00",
  ...
  },
  {
    id: "app-011",
    leadId: "lead-005",
    title: "Schoorsteenreparatie",
    description: "Reparatie schoorsteen en dakpannen vervangen",
    date: formatDate(addDays(today, 2)),
    startTime: "09:00",
    endTime: "14:00",
    status: "scheduled",
  ...
  },
  {
    id: "app-012",
    leadId: "lead-003",
    title: "Dakgoten vervangen",
    description: "Vervangen van alle dakgoten rondom huis",
    date: formatDate(addDays(today, 3)),
    startTime: "08:30",
    endTime: "16:30",
    status: "scheduled",
  ...
  },
  {
    ...
    leadId: "lead-002",
    title: "Dakinspectie",
    description: "Jaarlijkse dakinspectie en kleinschalig onderhoud",
    date: formatDate(addDays(today, 3)),
    startTime: "10:00",
    endTime: "12:00",
    status: "scheduled",
  ...
  },
  {
    id: "app-014",
    leadId: "lead-004",
    title: "Offerte dakisolatie",
    description: "Klant wil betere isolatie voor energiebesparing",
  ...
  },
  {
    id: "app-015",
    leadId: "lead-001",
    title: "Dakrenovatie groot project",
    description: "Complete renovatie appartementencomplex",
    date: formatDate(addDays(today, 4)),
    startTime: "08:00",
    endTime: "17:00",
    status: "scheduled",
    ...
    createdAt: formatDateTime(subDays(today, 30)),
    updatedAt: formatDateTime(subDays(today, 25)),
  },
];
