...
export const useWorkAgreementForm = (workAgreementId?: string) => {
  ...
  // Load work agreement data when editing
  useEffect(() => {
  ...
  // Update line items and customer when quote is selected
  useEffect(() => {
    if (selectedQuote) {
      ...
      // Set description from quote if empty
      ...
      // Set quoteId in workAgreement
      setWorkAgreement(prev => ({
        ...prev,
        quoteId: selectedQuote.id
      }));
      
      // Set totalAmount from quote
      setWorkAgreement(prev => ({
        ...prev,
